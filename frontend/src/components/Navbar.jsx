...
const Navbar = () => {
  ...
  useEffect(()=>{
    ...
    <li><a href='/' className='dark:bg-slate-900 dark:text-white'>Home</a></li>
     ...
     <li><a className='dark:bg-slate-900 dark:text-white'>Contact</a></li>
     <li><a className='dark:bg-slate-900 dark:text-white'>About</a></li>
    </>)
  return (
  ...
  <div className="navbar-start">
    ...
    <a className=" text-2xl cursor-pointer font-bold dark:bg-slate-900  dark:tet-white">BookStore</a>
  </div>
...
<label className="swap swap-rotate space-x-4">
  ...
  <div >
    <a className="bg-black text-white px-2 py-1 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
    <Login/>
  </div>
</div>
</div>
